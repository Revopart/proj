...
void RedBlackTree<Key, T, Compare, Allocator>::balanceInsert(
    node_type newNode) {
...
template <class Key, class T, class Compare, class Allocator>
void RedBlackTree<Key, T, Compare, Allocator>::swapNode(node_type to,
                                                        node_type from,
                                                        bool isNull) {
  if (to == root_) {
    root_ = from;
...
RedBlackTree<Key, T, Compare, Allocator>::getRightSwappedNode(node_type node) {
